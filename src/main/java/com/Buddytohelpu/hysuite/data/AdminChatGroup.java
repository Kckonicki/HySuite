...
public class AdminChatGroup {
    ...
    private String permission = "hysuite.adminchat.staff";
    ...
    public static AdminChatGroup staffGroup() {
        return new AdminChatGroup("staff", "Staff Chat", "hysuite.adminchat.staff", "[STAFF]", "#58a6ff");
    }
    ...
    public static AdminChatGroup adminGroup() {
        return new AdminChatGroup("admin", "Admin Chat", "hysuite.adminchat.admin", "[ADMIN]", "#f85149");
    }
}
