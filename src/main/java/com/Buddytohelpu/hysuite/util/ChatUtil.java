...
/**
 * Utility for sending formatted messages with integrated color and formatting support.
 * Includes internal implementation of chat customization features.
 *
...
public final class ChatUtil {
    private static final PluginIdentifier CHAT_CUSTOMIZATION_ID = new PluginIdentifier("com.Buddytohelpu", "ChatCustomization");
     ...
     * Supports named colors (RED, GOLD, etc.) and hex colors.
     */
    @Nonnull
    public static String toHex(@Nonnull String color) {
        // Use internal ColorUtil
