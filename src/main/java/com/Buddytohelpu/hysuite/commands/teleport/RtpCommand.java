package com.Buddytohelpu.hysuite.commands.teleport;
    ...
    private Integer findSafeY(WorldChunk chunk, int worldX, int worldZ) {
        ...
        for (int y = MAX_Y; y >= MIN_Y; y--) {
            ...
            if (blockBelow != 0 && blockAt == 0 && blockAbove == 0) {
                // TODO: Update when Hytale API provides replacement for deprecated getFluidId()
                // Checking for water/lava at teleport location to ensure safety
